...
- **Proposal to Fund Sponsors of Adjustable 15% Flat Tax:** Initial rate to 15% adjusted every two-year Congressional Election cycle, according to voters willingness and reaction to candidates' campaign promises vs forming an 87K IRS army which the GOP might suddenly think is a great idea if gaining control of Congress. 
...
##XDCPay Wallet Chrome Extension
An **[XDCPay](https://chrome.google.com/webstore/detail/xdcpay/bocpokimicclpaiekenaeelehdjllofo)** Chrome extension is available but is yet to connect to XDAO apps.
